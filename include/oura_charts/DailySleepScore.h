...
namespace oura_charts
{
   ...
   public:
      ...
      int contribDeepSleep() const noexcept     { return m_data.contributors.deep_sleep;  };
      int contribEfficiency() const noexcept    { return m_data.contributors.efficiency;  };
      int contribLatency() const noexcept       { return m_data.contributors.latency;     };
      int contribRemSleep() const noexcept      { return m_data.contributors.rem_sleep;   };
      int contribRestfulness() const noexcept   { return m_data.contributors.restfulness; };
      int contribTiming() const noexcept        { return m_data.contributors.timing;      };
      int contribTotalSleep() const noexcept    { return m_data.contributors.total_sleep; };
